...
第十组成员：
- 陈家龙 24300980041，负责后端设计与实现。
- 刘俊彦 24300980021，负责前端设计与实现。
- 陈清宇 24300680062，负责数据库与SQL设计与实现。
- 吴雨泽 24300980059，负责期中与期末PPT文档编写。
...
| 部署 | 线上部署使用 Ubuntu VPS、Nginx、Gunicorn、Let's Encrypt HTTPS，访问子路径为 `/bookstore/` |
